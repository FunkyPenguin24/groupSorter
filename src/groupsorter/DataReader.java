...
public class DataReader {
    ...
    ArrayList<Student> loadStudents() throws SQLException {
        ...
        while (rs.next()) {
            Student newStudent = new Student(rs.getString("studentName"), rs.getString("prefRole"), rs.getDouble("attendance")); //creates a new student with the attributes of that in the table
